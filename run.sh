...
# bats
# python run_grid_search.py --experiment bats --model gvar --K 3 --self_other --CF_pred --percept --TEST 

# peregrine
# python run_grid_search.py --experiment peregrine --model gvar --K 3 --self_other --CF_pred --percept --TEST 

# sula
# python run_grid_search.py --experiment sula --model gvar --K 3 --self_other --CF_pred --percept --TEST 

# mice
# python run_grid_search.py --experiment mice --model gvar --K 3 --TEST --data_dir ../ABM_data
# python run_grid_search.py --experiment mice --model gvar --K 3 --self_other --CF_pred --percept --TEST --data_dir ../ABM_data

# flies
# python run_grid_search.py --experiment flies --model gvar --K 3 --TEST  
# python run_grid_search.py --experiment flies --model gvar --K 3 --self_other --CF_pred --percept --TEST 
